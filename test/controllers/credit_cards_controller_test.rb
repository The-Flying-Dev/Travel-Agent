...
class CreditCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post credit_cards_url, params: { credit_card: { company: @credit_card.company, customer_id: @credit_card.customer_id, exp_date: @credit_card.exp_date, name_on_card: @credit_card.name_on_card, number: @credit_card.number } }
    end
  ...
  test "should update credit_card" do
    patch credit_card_url(@credit_card), params: { credit_card: { company: @credit_card.company, customer_id: @credit_card.customer_id, exp_date: @credit_card.exp_date, name_on_card: @credit_card.name_on_card, number: @credit_card.number } }
