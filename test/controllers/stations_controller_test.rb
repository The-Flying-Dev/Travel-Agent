...
class StationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post stations_url, params: { station: { lat: @station.lat, long: @station.long, name: @station.name, town: @station.town } }
    end
  ...
  test "should update station" do
    patch station_url(@station), params: { station: { lat: @station.lat, long: @station.long, name: @station.name, town: @station.town } }
