...
class JourneysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create journey" do
    assert_difference('Journey.count') do
      post journeys_url, params: { journey: { name: @journey.name, train_id: @journey.train_id } }
    end
  ...
  test "should update journey" do
    patch journey_url(@journey), params: { journey: { name: @journey.name, train_id: @journey.train_id } }
